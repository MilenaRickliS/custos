...
class TabelaGeralScreen extends StatefulWidget {
  const TabelaGeralScreen({super.key});

  @override
  State<TabelaGeralScreen> createState() => _TabelaGeralScreenState();
}

class _TabelaGeralScreenState extends State<TabelaGeralScreen> {
